...
//http://localhost:8080/TestFusion/FCExporter.jsp

java.util.Map map =request.getParameterMap();
System.out.println("xxxxxxxxxxxxxxxx="+map.size());
for (Iterator iterator = map.keySet().iterator(); iterator.hasNext();) {
	String key = (String) iterator.next();
	System.out.println(" key ======================= >"+key);
	System.out.println(" value=======================>"+request.getParameter(key));
}
System.out.println("exportFormat=>"+exportFormat+",exportTargetWindow=>"+exportTargetWindow);
...
System.out.println("exporter==>"+exporter.getPath());
if(exporter.exists()){%>
