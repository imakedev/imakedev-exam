...
<link rel="stylesheet" type="text/css" href="<c:url value='/resources/css/style-Login.css'/>" />
<style type="text/css">
.content_box_top { 
...
<div id="wrapper">
        ...
        <a href="#" title="MissConsult">
        <img src="<c:url value='/resources/images/logowebmc-b.png'/>"  border="0"/>        
        </a>
        </div>
        <div class="content_box">
        <div align="right" class="language" style="padding-top:50px; padding-right:10px;"><a title="Thai" href="?language=th_TH">TH</a> | <a title="English" href="?language=en">EN</a></div>
          <div style="border-bottom:2px dashed #BAC5C8; margin-bottom:8px;">
                    ...
                    <span style="color:#51FFDE;font-weight:bold; font-size:24px;">Candidate</span>
