...
public class RoleContactResource extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.aoe.makedev.missconsult.xstream.RoleContact.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.aoe.makedev.missconsult.xstream.RoleContact xbpsTerm = new th.co.aoe.makedev.missconsult.xstream.RoleContact();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.aoe.makedev.missconsult.xstream.RoleContact) ntcCalendarObj;
				if (xbpsTerm != null) {
				
					 
					th.co.aoe.makedev.missconsult.hibernate.bean.RoleContact bpsTerm = new th.co.aoe.makedev.missconsult.hibernate.bean.RoleContact();
					...
					if (xbpsTerm.getServiceName() != null
						...
						if(serviceName.equals(ServiceConstant.ROLE_CONTACT_FIND_BY_ID)){
							th.co.aoe.makedev.missconsult.hibernate.bean.RoleContact ntcCalendarReturn = roleContactService.findRoleContactById(bpsTerm.getRcId());
						logger.debug(" object return ="+ntcCalendarReturn);
						VResultMessage vresultMessage = new VResultMessage();
							if(ntcCalendarReturn!=null){
								List<th.co.aoe.makedev.missconsult.xstream.RoleContact> xntcCalendars = new ArrayList<th.co.aoe.makedev.missconsult.xstream.RoleContact>(1);
								th.co.aoe.makedev.missconsult.xstream.RoleContact xntcCalendarReturn = new th.co.aoe.makedev.missconsult.xstream.RoleContact();
						...
						/*else if(serviceName.equals(ServiceConstant.ROLE_CONTACT_ITEMS_DELETE)){
							...
							List<th.co.aoe.makedev.missconsult.xstream.RoleContact> xntcCalendars = roleContactService.listRoleContactBymaId(xbpsTerm.getMaId());
							...
							if (result != null && result.size() == 2) {
								@SuppressWarnings("unchecked")
								java.util.ArrayList<th.co.aoe.makedev.missconsult.hibernate.bean.RoleContact> ntcCalendars = (java.util.ArrayList<th.co.aoe.makedev.missconsult.hibernate.bean.RoleContact>) result
										.get(0);
								String faqs_size = (String) result.get(1);
//								 
								VResultMessage vresultMessage = new VResultMessage();

								List<th.co.aoe.makedev.missconsult.xstream.RoleContact> xntcCalendars = new ArrayList<th.co.aoe.makedev.missconsult.xstream.RoleContact>();
...
//			 
	...
	private List<th.co.aoe.makedev.missconsult.xstream.RoleContact> getxRoleContactObject(
			java.util.ArrayList<th.co.aoe.makedev.missconsult.hibernate.bean.RoleContact> ntcCalendars) {
		List<th.co.aoe.makedev.missconsult.xstream.RoleContact> xntcCalendars = new ArrayList<th.co.aoe.makedev.missconsult.xstream.RoleContact>(
				ntcCalendars.size());
		for (th.co.aoe.makedev.missconsult.hibernate.bean.RoleContact missManual : ntcCalendars) {
			th.co.aoe.makedev.missconsult.xstream.RoleContact xmissManual =new th.co.aoe.makedev.missconsult.xstream.RoleContact ();
	...
	private Representation returnUpdateRecord(Representation entity,th.co.aoe.makedev.missconsult.xstream.RoleContact xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.aoe.makedev.missconsult.xstream.RoleContact> xbpsTerms = new ArrayList<th.co.aoe.makedev.missconsult.xstream.RoleContact>(1);
