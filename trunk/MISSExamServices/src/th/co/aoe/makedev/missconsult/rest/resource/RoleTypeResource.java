...
public class RoleTypeResource extends BaseResource {
	...
	protected Representation post(Representation entity, Variant variant)
		...
		try {
			in = entity.getStream();
			xstream.processAnnotations(th.co.aoe.makedev.missconsult.xstream.RoleType.class);// or xstream.autodetectAnnotations(true); (Auto-detect  Annotations)
			th.co.aoe.makedev.missconsult.xstream.RoleType xbpsTerm = new th.co.aoe.makedev.missconsult.xstream.RoleType();
			Object ntcCalendarObj = xstream.fromXML(in);
			if (ntcCalendarObj != null) {
				xbpsTerm = (th.co.aoe.makedev.missconsult.xstream.RoleType) ntcCalendarObj;
				if (xbpsTerm != null) {
				
					 
					th.co.aoe.makedev.missconsult.hibernate.bean.RoleType bpsTerm = new th.co.aoe.makedev.missconsult.hibernate.bean.RoleType();
					...
					if (xbpsTerm.getServiceName() != null
						...
						if(serviceName.equals(ServiceConstant.ROLE_TYPE_FIND_BY_ID)){
							th.co.aoe.makedev.missconsult.hibernate.bean.RoleType ntcCalendarReturn = roleTypeService.findRoleTypeById(bpsTerm.getRtId());
						logger.debug(" object return ="+ntcCalendarReturn);
						VResultMessage vresultMessage = new VResultMessage();
							if(ntcCalendarReturn!=null){
								List<th.co.aoe.makedev.missconsult.xstream.RoleType> xntcCalendars = new ArrayList<th.co.aoe.makedev.missconsult.xstream.RoleType>(1);
								th.co.aoe.makedev.missconsult.xstream.RoleType xntcCalendarReturn = new th.co.aoe.makedev.missconsult.xstream.RoleType();
						...
						/*else if(serviceName.equals(ServiceConstant.ROLE_TYPE_ITEMS_DELETE)){
							...
							List<th.co.aoe.makedev.missconsult.xstream.RoleType> xntcCalendars = roleTypeService.listRoleTypeByRcId(xbpsTerm.getRcId());
							...
							@SuppressWarnings("unchecked")
							List<th.co.aoe.makedev.missconsult.xstream.RoleType> xntcCalendars = roleTypeService.listRoleTypes(xbpsTerm.getMaId());
							...
							if (result != null && result.size() == 2) {
								@SuppressWarnings("unchecked")
								java.util.ArrayList<th.co.aoe.makedev.missconsult.hibernate.bean.RoleType> ntcCalendars = (java.util.ArrayList<th.co.aoe.makedev.missconsult.hibernate.bean.RoleType>) result
										.get(0);
								String faqs_size = (String) result.get(1);
//								 
								VResultMessage vresultMessage = new VResultMessage();

								List<th.co.aoe.makedev.missconsult.xstream.RoleType> xntcCalendars = new ArrayList<th.co.aoe.makedev.missconsult.xstream.RoleType>();
...
//			 
	...
	private List<th.co.aoe.makedev.missconsult.xstream.RoleType> getxRoleTypeObject(
			java.util.ArrayList<th.co.aoe.makedev.missconsult.hibernate.bean.RoleType> ntcCalendars) {
		List<th.co.aoe.makedev.missconsult.xstream.RoleType> xntcCalendars = new ArrayList<th.co.aoe.makedev.missconsult.xstream.RoleType>(
				ntcCalendars.size());
		for (th.co.aoe.makedev.missconsult.hibernate.bean.RoleType roleType : ntcCalendars) {
			th.co.aoe.makedev.missconsult.xstream.RoleType xroleType =new th.co.aoe.makedev.missconsult.xstream.RoleType ();
	...
	private Representation returnUpdateRecord(Representation entity,th.co.aoe.makedev.missconsult.xstream.RoleType xbpsTerm,int updateRecord){
		VResultMessage vresultMessage = new VResultMessage();
		List<th.co.aoe.makedev.missconsult.xstream.RoleType> xbpsTerms = new ArrayList<th.co.aoe.makedev.missconsult.xstream.RoleType>(1);
