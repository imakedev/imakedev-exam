...
$(document).ready(function() {
 ...
 //$('select#bpgGroupId').selectmenu({style:'dropdown'});
	$("#demo1").jstree({ 
		...
		//$("li#"+id+" > a").removeClass('jstree-clicked');
		if(id!='undefined'){
          ...
          <tr>
			...
			<form class="well">
			    <table border="0" width="100%" style="font-size: 12px">
    				...
    				<tr>
    					<td width="25%">&nbsp;</td>
    					<td width="50%" colspan="2">Password&nbsp;&nbsp;:&nbsp;&nbsp;<input type="password"/></td>
			...
			<form class="well">
			    <table border="1" width="100%" style="font-size: 12px">
			    	<tr>
    					<td width="100%" colspan="4"><strong>MissConsult Profile</strong></td>
    				</tr>
   		 			<tr valign="top">
    					<td width="25%">Name:</td>
    					<td width="50%" colspan="2"><input type="text" width="100%" /></td>
    					 <td width="25%" rowspan="2"><img src="<c:url value='/resources/images/photo.png'/>"/><div align="center"><input type="button" value="Upload"></div></td>
    				</tr>
    				<tr valign="top">
    					<td width="25%">Address:</td>
    					<td width="50%" colspan="2"><textarea cols="4" rows="4" id="editor1"></textarea>
    					<script>
			    ...
			    <table border="1" width="100%" style="font-size: 12px">
			    	<tr>
    					...
    					<td width="50%" colspan="2"><input type="text" style="width: 120px" />&nbsp;<input type="text" style="width: 120px" /></td>
    					 <td width="25%" rowspan="8"><img src="<c:url value='/resources/images/photo.png'/>"/><div align="center"><input type="button" value="Upload"></div></td>
    				</tr>
    				<tr valign="top">
			...
			<form class="well">
			    <table border="1" width="100%" style="font-size: 12px">
    				...
    				<tr>
    					<td width="100%" colspan="4"><textarea cols="4" rows="4" id="editor11"></textarea>
    					<script>
    				...
    				<tr>
    					<td width="100%" colspan="4"><textarea cols="4" rows="4" id="editor2"></textarea>
    					<script>
    				...
    				<tr>
    					<td width="100%" colspan="4"><textarea cols="4" rows="4" id="editor3"></textarea>
    					<script>
