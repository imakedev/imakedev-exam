	    ...
	    <fieldset style="font-family: sans-serif;">  
          ...
          <form class="well">
              <table border="0" width="100%" style="font-size: 13px">
	    					...
	    					<tr>
	    					 <td align="center" width="17%" colspan="6">&nbsp;Group : <select name="bpsGroupId" id="bpgGroupId"> 
	    					...
	    					<a href="#">Prev</a>&nbsp;|&nbsp;<select name="paging" id="paging"> 
		...
		<table class="table table-striped table-bordered table-condensed" border="1" style="font-size: 12px">
        	...
        	<tbody>
          	<tr>
            	...
            	<td>EPT</td> 
            	<td><a href="<c:url value='/test/exam/1'/>">Edit</a> Delete</td> 
          	</tr>
          		<tr>
            	<td><input type="checkbox" /></td>
            	<td>MCCT</td> 
            	...
            	<td><a href="<c:url value='/test/account/1'/>">Edit</a> Delete</td> 
          	</tr>
        	</tbody>
      </table>
