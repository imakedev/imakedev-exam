	    ...
	    <fieldset style="font-family: sans-serif;">  
          ...
          <form class="well">
              <table border="0" width="100%" style="font-size: 13px">
	    					...
	    					<td align="left" width="17%"><select name="bpsGroupId2" id="bpgGroupId2"> 
											 <option value="0">1</option>
											 <option value="20">20</option>
											 <option value="300">300</option>
		...
		<table class="table table-striped table-bordered table-condensed" border="1" style="font-size: 12px">
        	...
        	<tbody>
          	<tr>
            	...
            	<td>300</td>
            	<td>xx</td>
            	<td><a href="<c:url value='/candidate/account/1'/>">xx</a></td>
            	<td>xx</td> 
          	</tr>
          <tr>
            	<td><input type="checkbox" /></td>
            	...
            	<td>300</td>
            	<td>xx</td>
            	<td><a href="<c:url value='/candidate/account/2'/>">xx</a></td>
            	<td>xx</td> 
          	</tr><tr>
            	<td><input type="checkbox" /></td>
            	<td>Company</td>
            	...
            	<td>300</td>
            	<td>xx</td>
            	<td><a href="<c:url value='/candidate/account/3'/>">xx</a></td>
            	<td>xx</td> 
          	</tr>
        	</tbody>
      </table>
