		...
		<table class="table table-striped table-bordered table-condensed" border="1" style="font-size: 12px;width: 100%">
        	...
        	<tbody>
        	 <c:forEach items="${missManuals}" var="missManual" varStatus="loop"> 
          	<tr> 
            	<td>&nbsp;<span style="cursor: pointer;" onclick="getFileAttached('getfile/attachManual/${missManual.missSery.msId}/${missManual.mmHotlink}')">${missManual.mmFileName}</span>&nbsp;(Series&nbsp;:&nbsp;${missManual.missSery.msSeriesName})</td>
          	</tr>
          	</c:forEach>
        	</tbody>
      </table>
