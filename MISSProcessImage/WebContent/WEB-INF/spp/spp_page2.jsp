...
<tr><td>
<div class="header">
	<div id="banner"> <img src="<c:url value='/images/spp/spp03.png' />" align="left" />
	</div>
</div>
<div class="body">
  ...
  <tr>
    ...
    <td><span class="rp_detail">ธรรศ  พงศาสนองกุล</span></td>
  </tr>
  <tr>
  ...
  <tr>
	...
	&nbsp;
	<img src="<c:url value='/images/spp/spp04.png'/>" />
    <div id="introduce">
...
Position.</p>
    <p>แบบประเมิน Sales Performance Predictor หรือ Sale PP® เป็นแบบประเมินสำหรับตำแหน่งงานฝ่ายขายเท่านั้น โดยรูปแบบประเมินเป็นการ ประเมินถึงระดับความเหมาะสมของบุคคลในการทำงานสำหรับตำแหน่งงานฝ่ายขาย วัตถุประสงค์ของแบบประเมินคือ เครื่องมือสนับสนุนในการคัดเลือก พนักงานเข้าสู่ตำแหน่งงานฝ่ายขายโดยแบบประเมินจะให้แนวโน้มทางด้านคุณสมบัติที่จำเป็นต้องมีของบุคคลสำหรับตำแหน่งงานฝ่ายขาย</p>
    <p style="color:#4A708B; font-weight:bold;">ผลการทดสอบของคุณ&nbsp;<span id="intro_name">ธรรศ  พงศาสนองกุล</span>&nbsp;เป็นดังนี้</p>
    <p style="color:#990000; font-weight:bold;">1. ลักษณะการตอบคำถามของแบบทดสอบ - Lie Detector Result</p>
    <img src="<c:url value='/images/spp/spp05.png'/>" hspace="90"  />
...
reliable. ผู้ทดสอบอาจมีความกังวลในการทำข้อสอบหรือคิดมาก ทำให้ตอบข้อสอบบางข้อเพื่อตั้งใจดูดีหรือตั้งใจให้ผลออกมาดีแต่สามารถเชื่อถือผลคะแนนได้</p>
	<p style="color:#0000FF; font-weight:bold;">2. ผลทดสอบ Sales Scale - Sales Performance Predictor Result</p>
