          ...
          <tr>
			...
			<form class="well">
			    <table border="0" width="100%" style="font-size: 12px">
   		 			<tr>
    					<td width="25%">&nbsp;</td>
    					<td width="50%" colspan="2">Username&nbsp;&nbsp;:&nbsp;&nbsp;<input type="text" value="Moooo1" ></td>
    					 
    					<td width="25%">&nbsp;</td>
    				</tr>
    				<tr>
    					<td width="25%">&nbsp;</td>
    					<td width="50%" colspan="2">Password&nbsp;&nbsp;:&nbsp;&nbsp;<input type="password" value="1111"/></td>
			...
			<form class="well">
			    <table border="1" width="100%" style="font-size: 12px">
    				...
    				<tr valign="top">
    					...
    					<td width="50%" colspan="2"><textarea cols="4" rows="4" id="editor11"></textarea>
    					<script>
			...
			<form class="well">
			    ...
			    <table border="1" width="100%" style="font-size: 12px">
    				...
    				<tr>
    					<td width="100%" colspan="4"><textarea cols="4" rows="4" id="editor1"></textarea>
    					<script>
