...
public interface MissSurveySendService  {
		...
		public  List<List<String>> sendSurvey(MissSurveySend persistentInstance,Long maId,List<List<String>> userEmail) throws DataAccessException ;	
		public  List<List<String>> sendSurveyGroup(List<MissSurveySend> missSurveySends,Long maId) throws DataAccessException ;
